...
function validateProduct() {
    ...
    const stars = document.querySelector("#stars").value.trim();
    const type = document.querySelector("#type").value.trim();
    const desc = document.querySelector("#desc").value.trim();
    const alts = document.querySelector("#alts").value;
    ...
    const starsError = document.querySelector("#stars_error");
    ...
    if (color == "") {
        colorError.innerHTML = "Please enter product color.";
        check = false;
    } else {
    ...
    if (isNaN(stars)) {
        starsError.innerHTML = "Please enter the number.";
        check = false;
    } else if (parseFloat(stars) < 0 || parseFloat(stars) > 5) {
        starsError.innerHTML = "Stars must be between 0 and 5.";
        check = false;
    } else {
        starsError.innerHTML = "";
    }
